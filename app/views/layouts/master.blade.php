...
<head>
  ...
  <link rel="shortcut icon" href="{{ URL::secure_asset('assets/favicon.ico') }}">

  <link rel="stylesheet" type="text/css" href="{{ URL::secure_asset('assets/css/semantic.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ URL::secure_asset('assets/css/style.css') }}">

  <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.3/jquery.js"></script> -->
  <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
  <script src="{{ URL::secure_asset('assets/js/semantic.min.js') }}"></script>
  <script src="{{ URL::secure_asset('assets/js/style.js') }}"></script>
